...
class Version extends \Opencart\System\Engine\Controller {
	...
	public function index(string &$route, array &$args, mixed &$output): void {
        ...
        if ($resposta['asaas'] > $version) {
            echo '<div class="alert alert-info" role="alert">Atenção: tem uma nova versão do módulo <b>Asaas</b>, disponível para <a href="https://www.opencart.com/index.php?route=marketplace/extension/info&extension_id=48210&filter_search=asaas" target="_blank">download</a>!</div>';
